...
public class BlockChainTest {
    ...
    public void setUp() {
        ...
        testNetChain = new BlockChain(testNet, new Wallet(testNet, new MemoryKeyStore()), new MemoryBlockStore(testNet));
    ...
    public void receiveCoins() throws Exception {
        ...
        Transaction tx1 = createFakeTx(unitTestParams,
                                       ...
                                       wallet.getKeyStore().getKeys()[0].toAddress(unitTestParams));
