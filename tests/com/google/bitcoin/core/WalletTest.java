...
import com.google.bitcoin.keystore.SQLiteKeyStore;
...
public class WalletTest {
    ...
    public void setUp() throws Exception {   
        ...
        myKey = new ECKey();
        keyStore.addKey(myKey);
        
        /*Uncomment to try with a db keystore*/
//        File temp = File.createTempFile("bcj_sqlks", ".dat");
//        String dbPath = temp.getAbsolutePath();
//        SQLiteKeyStore keyStore = SQLiteKeyStore.create(dbPath);
//        keyStore.addKey(myKey, 1);
