 ...
 * You must then call {@link PaymentChannelClientState#storeChannelInWallet(com.google.dogecoin.core.Sha256Hash)} to store the refund transaction
...
public class PaymentChannelClientState {
     ...
     *              It is suggested you use at least {@link com.google.dogecoin.core.Utils#CENT} to avoid paying fees if you need to spend the refund transaction
