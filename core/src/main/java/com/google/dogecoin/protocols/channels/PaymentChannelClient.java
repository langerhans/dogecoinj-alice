...
public class PaymentChannelClient implements IPaymentChannelClient {
     ...
     * {@link ClientConnection#destroyConnection(com.google.dogecoin.protocols.channels.PaymentChannelCloseException.CloseReason)} to settle the connection, it does not
