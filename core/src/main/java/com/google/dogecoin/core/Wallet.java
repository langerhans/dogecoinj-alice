...
public class Wallet implements Serializable, BlockChainListener, PeerFilterProvider {
     ...
     * {@link com.google.dogecoin.store.WalletProtobufSerializer}. Writes out first to a temporary file in the same directory and then renames
     * once written.
     */
     ...
     * {@link com.google.dogecoin.store.WalletProtobufSerializer}.
     */
    ...
    private void receive(Transaction tx, StoredBlock block, BlockChain.NewBlockType blockType,
        ...
        log.info("Received tx{} for {} DOGE: {} [{}] in block {}", sideChain ? " on a side chain" : "",
                Utils.bitcoinValueToFriendlyString(valueDifference), tx.getHashAsString(), relativityOffset,
...
//                            throw new IllegalArgumentException("Tried to send dust with ensureMinRequiredFee set - no way to complete this");
    ...
    public String toString(boolean includePrivateKeys, boolean includeTransactions, boolean includeExtensions,
        ...
        try {
            ...
            builder.append(String.format("Wallet containing %s DOGE (%d satoshis) in:%n",
                    Utils.bitcoinValueToPlainString(balance), balance.longValue()));
