...
public class Transaction extends ChildMessage implements Serializable {
    ...
    /**
     * Same as {@link #addSignedInput(TransactionOutPoint, com.google.dogecoin.script.Script, ECKey, Transaction.SigHash, boolean)}
     ...
     * 
     * @param wallet Wallet to check whether transaction isMine or not
