...
public class CoinBaseBlockTest {
    ...
    public void testReceiveCoinbaseTransaction() throws Exception {
    	...
    	// The private key MINERS_KEY is used to check transactions are received by a wallet
    	// correctly and that coinbase transactions are unavailable to spend for 120 blocks
    	String blockAsHex = read(getClass().getResourceAsStream("block169482.txt"));
    	assertEquals(BLOCK_LENGTH_AS_HEX, blockAsHex.length());
        ...
        // Initial balance should always be zero by construction
