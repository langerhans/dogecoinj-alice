...
public class ChainSplitTest {
    ...
    public void testForking3() throws Exception {
        ...
        Assert.assertEquals(TransactionConfidence.ConfidenceType.PENDING, spend.getConfidence().getConfidenceType());
        ...
        Assert.assertEquals(TransactionConfidence.ConfidenceType.BUILDING, spend.getConfidence().getConfidenceType());
    ...
    public void testForking4() throws Exception {
        ...
        Assert.assertEquals(TransactionConfidence.ConfidenceType.PENDING, tx.getConfidence().getConfidenceType());
        Block b4 = b3.createNextBlock(someOtherGuy);
        chain.add(b4);
        // The external spend is now active.
        assertEquals(Utils.toNanoCoins(0, 0), wallet.getBalance());
        Assert.assertEquals(TransactionConfidence.ConfidenceType.BUILDING, tx.getConfidence().getConfidenceType());
    }
    ...
    public void testDoubleSpendOnForkPending() throws Exception {
        ...
        Assert.assertEquals(TransactionConfidence.ConfidenceType.DEAD, t1.getConfidence().getConfidenceType());
        Assert.assertEquals(TransactionConfidence.ConfidenceType.PENDING, t2.getConfidence().getConfidenceType());
    }
    ...
    public void txConfidenceLevels() throws Exception {
        ...
        Assert.assertEquals(TransactionConfidence.ConfidenceType.PENDING, txns.get(1).getConfidence().getConfidenceType());
        try {
    ...
    public void coinbaseDeath() throws Exception {
        ...
        Assert.assertEquals(TransactionConfidence.ConfidenceType.BUILDING, txns.get(1).getConfidence().getConfidenceType());
