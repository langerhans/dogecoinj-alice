...
public class BlockChainTest {
    ...
    public void receiveCoins() throws Exception {
        ...
        Block b1 = TestUtils.createFakeBlock(blockStore, tx1).block;
        chain.add(b1);
    ...
    public void merkleRoots() throws Exception {
        ...
        Transaction tx2 = TestUtils.createFakeTx(unitTestParams, Utils.toNanoCoins(1, 0),
                new ECKey().toAddress(unitTestParams));
        Block b2 = TestUtils.createFakeBlock(blockStore, tx2).block;
        b2.getMerkleRoot();
...
//    }
    ...
    public void coinbaseTransactionAvailability() throws Exception {
        ...
        Transaction tx3 = TestUtils.createFakeTx(unitTestParams, Utils.toNanoCoins(1, 0), new ECKey().toAddress(unitTestParams));
        Block b3 = TestUtils.createFakeBlock(blockStore, tx3).block;
        chain.add(b3);
        ...
        Block b4 = TestUtils.createFakeBlock(blockStore, coinbaseSend2).block;
        chain.add(b4);
